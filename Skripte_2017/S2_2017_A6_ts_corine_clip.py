...
# Ordner mit den Input-Dateien
input_folders = [
    "[absoluter_Pfad]/Python/output_ts_SCL/EVI",
    "[absoluter_Pfad]/Python/output_ts_SCL/NDMI",
    "[absoluter_Pfad]/Python/output_ts_SCL/NDVI",
    "[absoluter_Pfad]/Python/output_ts_SCL/NDWI",
    "[absoluter_Pfad]/Python/output_ts_SCL/NMDI"
]
...
for input_folder in input_folders:
    ...
    for tif_file in tif_files:
        ...
        with rasterio.open(tif_file) as src:
            # Setzen des nodata-Wertes
            nodata = src.nodata if src.nodata is not None else -9999
            
            # Zuschneiden des Rasters mit dem Shapefile und Setzen der nodata-Werte
