...
all_input_folders = [
    [
        "[absoluter_Pfad]/Python/output_ts_TUG1_SCL/EVI",
        "[absoluter_Pfad]/Python/output_ts_TUG1_SCL/NDMI",
        "[absoluter_Pfad]/Python/output_ts_TUG1_SCL/NDVI",
        "[absoluter_Pfad]/Python/output_ts_TUG1_SCL/NDWI",
        "[absoluter_Pfad]/Python/output_ts_TUG1_SCL/NMDI"
    ],
    [
        "[absoluter_Pfad]/Python/output_ts_TUG2_SCL/EVI",
        "[absoluter_Pfad]/Python/output_ts_TUG2_SCL/NDMI",
        "[absoluter_Pfad]/Python/output_ts_TUG2_SCL/NDVI",
        "[absoluter_Pfad]/Python/output_ts_TUG2_SCL/NDWI",
        "[absoluter_Pfad]/Python/output_ts_TUG2_SCL/NMDI"
    ],
    [
        "[absoluter_Pfad]/Python/output_ts_TUG3_SCL/EVI",
        "[absoluter_Pfad]/Python/output_ts_TUG3_SCL/NDMI",
        "[absoluter_Pfad]/Python/output_ts_TUG3_SCL/NDVI",
        "[absoluter_Pfad]/Python/output_ts_TUG3_SCL/NDWI",
        "[absoluter_Pfad]/Python/output_ts_TUG3_SCL/NMDI"
    ],
    [
        "[absoluter_Pfad]/Python/output_ts_TUG4_SCL/EVI",
        "[absoluter_Pfad]/Python/output_ts_TUG4_SCL/NDMI",
        "[absoluter_Pfad]/Python/output_ts_TUG4_SCL/NDVI",
        "[absoluter_Pfad]/Python/output_ts_TUG4_SCL/NDWI",
        "[absoluter_Pfad]/Python/output_ts_TUG4_SCL/NMDI"
    ]
]
