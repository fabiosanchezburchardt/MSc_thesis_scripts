...
# Verzeichnis
base_dir = "[absoluter_Pfad]/Python/output_ba/"

# Liste der Indizes
indices = ["BAIS2", "NBR", "NBRplus"]

# Liste der Zeitpunkte
dates = ["20170612", "20170917"]

# Pfade für die SCL-Raster
scl_paths = {
    "20170612": "[absoluter_Pfad]/Python/output_ba/20170612/20170612_SCL_20m_pollino.tif",
    "20170917": "[absoluter_Pfad]/Python/output_ba/20170917/20170917_SCL_20m_pollino.tif"
}
