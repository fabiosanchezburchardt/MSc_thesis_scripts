...
# Vorverarbeitung der Sentinel-2 Einzelband-Raster für die Trockenstressuntersuchung
...
input_parent_folder = "[absoluter_Pfad]/Python/input_ts"

# Übergeordneter Output-Ordner
output_parent_folder = "[absoluter_Pfad]/Python/output_ts"

# Merge-Ordner
merge_parent_folder = "[absoluter_Pfad]/Python/merge/ts"

# Pfad zum Shapefile
shapefile_path = "[absoluter_Pfad]/Python/input_shp/pollino_np.shp"
...
for subfolder in subfolders:
    ...
    for spectral_folder in spectral_folders:
        ...
        output_merge_path = os.path.join(output_timepoint_folder_merge, f"{subfolder}_{spectral_folder}_10m_merge.tif")
        ...
        # Öffnen des GeoTIFF-Bildes für den aktuellen Spektralband-Unterordner (Merge)
